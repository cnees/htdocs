...
echo "<style>";
echo ".index{top:20px;left:20px;width:" . $colNum*20 . "px;}";

echo "form{position:absolute;top:" . (($rowNum*10)+50) . "px;left:20px;}";
...
{	
	...
	{
	echo "<div id=\"color" . $ColorDiv . "\" class=\"index\" style=\"position:absolute;\">"; //Create a div with class color1, color2, color3...
		echo "<table width=\"150\" height=\"20\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">"; //Each ColorDiv has a table right inside of it.
